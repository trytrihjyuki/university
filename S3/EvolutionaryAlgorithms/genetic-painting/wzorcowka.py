...
REFERENCE = Image.open('static/small_lisa.jpeg')
...
if __name__ == "__main__":  
    ...
    while True:
        ...
        print("\nstarting generation %s. Best of breed is %s (%s): %s " % (i, crossover_strains[0].name, len(crossover_strains[0].dna), crossover_strains[0].fitness()))
